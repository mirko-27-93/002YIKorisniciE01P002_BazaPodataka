...
DELIMITER ZZ
CREATE DEFINER=`root`@`localhost` PROCEDURE yi.userdatabase_AD_PROC(IN old_username VARCHAR(45))
BEGIN
...
DELIMITER ZZ
CREATE DEFINER=`root`@`localhost` PROCEDURE yi.userdatabase_AU_PROC(IN old_username VARCHAR(45), IN neo_username VARCHAR(45))
BEGIN
...
DELIMITER %%
CREATE DEFINER=`root`@`localhost` PROCEDURE yi.userdatabase_AI_PROC(IN neo_username VARCHAR(45),IN neo_password VARCHAR(45))
BEGIN
